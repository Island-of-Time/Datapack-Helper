package de.miraculixx.maptools.utils.gui.logic

import de.miraculixx.kpaper.extensions.kotlin.toMap
import de.miraculixx.kpaper.items.KHeads
import de.miraculixx.maptools.utils.gui.logic.data.CustomInventory
import de.miraculixx.maptools.utils.gui.logic.items.ItemFilterProvider
...
class StorageGUI(
    ...
    private val arrowUpRed = if (scrollable) InventoryUtils.getCustomItem("arrowUpRed", 9000, KHeads.ARROW_UP_RED) else null
    private val arrowDownRed = if (scrollable) InventoryUtils.getCustomItem("arrowDownRed", 9000, KHeads.ARROW_DOWN_RED) else null
    private val arrowUpGreen = if (scrollable) InventoryUtils.getCustomItem("arrowUpGreen", 9001, KHeads.ARROW_UP_GREEN) else null
    private val arrowDownGreen = if (scrollable) InventoryUtils.getCustomItem("arrowDownGreen", 9002, KHeads.ARROW_DOWN_GREEN) else null
