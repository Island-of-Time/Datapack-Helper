...
class ScrollGUI(
    ...
    private val arrowRedL = InventoryUtils.getCustomItem("arrowLeftEnd", 9000, KHeads.ARROW_LEFT_RED)
    private val arrowRedR = InventoryUtils.getCustomItem("arrowRightEnd", 9000, KHeads.ARROW_RIGHT_RED)
    private val arrowGreenL = InventoryUtils.getCustomItem("arrowLeft", 9001, KHeads.ARROW_LEFT_GREEN)
    private val arrowGreenR = InventoryUtils.getCustomItem("arrowRight", 9002, KHeads.ARROW_RIGHT_GREEN)
