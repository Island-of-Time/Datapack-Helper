...
import de.miraculixx.maptools.command.multiToolData
import de.miraculixx.maptools.command.multiToolSelection
import de.miraculixx.maptools.utils.*
import de.miraculixx.maptools.utils.SettingsManager.highlightFence
import de.miraculixx.maptools.utils.SettingsManager.highlightGlobal
import de.miraculixx.maptools.utils.SettingsManager.highlightPinkGlass
import de.miraculixx.maptools.utils.SettingsManager.highlightSlabs
import de.miraculixx.maptools.utils.SettingsManager.highlightStairs
import de.miraculixx.maptools.utils.SettingsManager.highlightWalls
...
object ToolEvent {
    val key = NamespacedKey(MapTools.INSTANCE, "webserver.command-item1")
    val key2 = NamespacedKey(MapTools.INSTANCE, "webserver.command-item2")
    val key3 = NamespacedKey(MapTools.INSTANCE, "webserver.command-item3")
    val keyCommand = NamespacedKey(MapTools.INSTANCE, "webserver.command-tool")

    private val tagOffset = NamespacedKey(MapTools.INSTANCE, "offset")
    private val tagX = NamespacedKey(MapTools.INSTANCE, "x")
    private val tagZ = NamespacedKey(MapTools.INSTANCE, "z")
