...
import de.miraculixx.maptools.utils.SettingsManager.groupFolders
import de.miraculixx.maptools.utils.Zipping
...
class TexturePackCommand : Module {
    private val mWebAPI = if (MapTools.mWebLoaded) MapTools.mWebAPI else null
